...
select * from tbl_order_detail where order_detail_mid='test02';
...
INSERT INTO tbl_cart VALUES (cart_no_seq.nextval, 'test02', 2, 4);
INSERT INTO tbl_cart VALUES (cart_no_seq.nextval, 'test02', 3, 6);
